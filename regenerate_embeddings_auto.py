"""
Script để regenerate embeddings với context được cải thiện (tự động)
"""
...
def main():
   ...
   # print(f"Embedding dimension: {stats['embedding_dim']}")
    ...
    print("\n" + "="*60)
    print("TESTING SEMANTIC SEARCH WITH NEW EMBEDDINGS")
    print("="*60)
    ...
    results = embeddings.semantic_search(question, top_k=10)
